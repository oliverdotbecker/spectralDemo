...
der Referenzpunkt sich, gegen den Uhrzeigersinn gesehen, links von der Geraden zweier aufeinanderfolgender Koordinaten ist. Wenn diese Bedingung für alle Geraden
erfüllt ist, befindet sich der Referenzpunkt innerhalb des kombinierten Gamuts.\\
...
verwendeten Lampen RGBW Lichtquellen besitzen, gibt es mehrere Möglichkeiten eine Farbe zu mischen. Für komplexere Testaufbauten gibt es allerdings in der
Veranstaltungstechnik auch übliche Lampen mit fünf oder mehr Emittern, beispielsweise RGBWA (Amber) Geräte.\\
...
Weiter müssen für eine potenzielle Farbmischung alle verfügbaren Emitter betrachtet werden. Wie in Bild \ref{fig:triangleCombined} ist der weiße
...
definieren, würde in diesem Beispiel der weiße Emitter nicht berücksichtigt werden. Die einfachste Form und minimalistischte Form der Segmentierung
einer Fläche ist das Dreieck.
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.8\textwidth]{images/combined_gamut_with_mix_triangles_cyan.png}
    \end{center}
    \caption{Kombinierter Gamut eines SkyPanels mit Mixdreiecken und einer LightCan}\label{fig:triangleCombined}
\end{figure}
\noindent
Somit werden nun aus allen möglichen Emitterkombinationen immer ein Dreieck aus drei Emittern einer Lampe betrachtet. Die Vertices des Dreiecks werden gegen
