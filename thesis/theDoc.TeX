...
diese Daten in der Praxis selten von Herstellen zur Verfügung gestellt werden.\\
\\
...
kann mit der aus dieser Arbeit resultierenden Software Scheinwerfer per Art-Net angesteuert werden.\\
\\
Diese Funktionen wurden in Software in Verbindung mit Peripherie Hardware realisiert.
\clearpage
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llll}
        ...
        MacAdam Ellipsen & > 35     & > 35     & > 35     & \textasciitilde 10\\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} lll}
                         & x        & y        & MacAdam Ellipsen\\
        Vorberechnet     & 0.1624   & 0.34     & > 36\\
        Skypanel (Ref)   & 0,1528   & 0,1694   & -\\
        LEDWash 300      & 0,1565   & 0,1965   & \textasciitilde 2\\
        LightCan         & 0,152    & 0,2128   & < 6\\
    \end{tabular*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%% Ausblick %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Ausblick}
Mit anderen Sensoren oder einem integrierbaren Spektrometer
\clearpage
