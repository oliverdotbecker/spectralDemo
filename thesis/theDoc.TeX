...
Die mit dem Spektrometer gemessenen Werte sind tabellarisch und als Diagramme im Anhang zu finden.\\
...
\paragraph{}
\noindent
Die erfassten Messwerte mit dem AS7262 unterscheiden sich deutlich von den mit dem Spektrometer aufgezeichneten Daten.
\paragraph{}
{\color{red}
Hier folgen Notizen:\\
...
\begin{addmargin}[4em]{0em}
    * Ausführliche Erklärung des AS7262 Messfehlers -> Ausscheiden des Sensors (keine Interpolation möglich)\\
    * Verleich Messdaten AS7262 und Spektrometer\\
    * Einbinden der Spektrometerdaten\\
    * Light Can innere Algorithmen (Ansatz zum Messen von Mischfarben zur Nachbildung des Mischalgorithmus)
\end{addmargin}
\begin{addmargin}[2em]{0em}
    - Exemplarische Ergebnisse des Farbabgleichs. MacArthur Ellipsenanalyse der Farbabweichungen zur Referenzfarbe
\end{addmargin}}
\clearpage

%%%%%%%%%%%%%%%%%%%%%%%%%% Ausblick %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Ausblick}
Mit einer entsprechenden Kalibrierung oder anderen genaueren Sensoren wäre ein deutlich genauerer Abgleich
verschiedener LED Lichtquellen möglich. Der entscheidendste Faktor ist die Messdatenbasis.\\
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Prozent [\%] & 5  & 10 & 20 & 35 & 50  & 65  & 85  & 100\\
        DMX          & 12 & 25 & 51 & 89 & 127 & 165 & 216 & 255\\
    \end{tabular*}
    \caption{DMX Werte zu Ansteuerungswerten in Prozent}
\end{table}
\noindent
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llll}
        Lux   & Rot   & Grün  & Blau & Weiss\\
        5\%   & 791   & 1075  & 325  & 3583 \\
        10\%  & 1541  & 2154  & 637  & 7279 \\
        20\%  & 3004  & 4240  & 1254 & 15094\\
        35\%  & 5221  & 7383  & 2185 & 27255\\
        50\%  & 7459  & 10621 & 3139 & 36158\\
        65\%  & 9618  & 13785 & 4020 & 42448\\
        85\%  & 12463 & 18014 & 4900 & 52849\\
        100\% & 14554 & 21179 & 5408 & 65884\\
    \end{tabular*}
    \caption{Gemessene Luminanz Werte des Skypanel}
\end{table}
\noindent
\begin{figure}[H]
    \begin{center}
    ...
    \end{center}
    \caption{Darstellung Luminanz der SkyPanel Emitter}
\end{figure}
\begin{figure}[H]
    \begin{center}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,6844 & 0,684  & 0,6841 & 0,6834 & 0,6835 & 0,6826 & 0,6813 & 0,679  \\
        y (Rot)          & 0,3092 & 0,3094 & 0,3096 & 0,3097 & 0,3101 & 0,3101 & 0,3104 & 0,3107 \\
        MacAdam Ellipsen & -      & > 1    & > 1    & > 1    & > 1    & > 1    & > 2    & > 3    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,1809 & 0,1787 & 0,1783 & 0,1783 & 0,179  & 0,1792 & 0,1799 & 0,1807 \\
        y (Rot)          & 0,7084 & 0,7136 & 0,7151 & 0,7165 & 0,716  & 0,7165 & 0,7162 & 0,7158 \\
        MacAdam Ellipsen & -      & > 1    & > 1    & > 1    & > 1    & > 1    & > 1    & > 1    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,1483 & 0,1476 & 0,1476 & 0,1474 & 0,1474 & 0,1474 & 0,147  & 0,1468 \\
        y (Rot)          & 0,0358 & 0,0348 & 0,0347 & 0,0345 & 0,0345 & 0,0351 & 0,0366 & 0,0377 \\
        MacAdam Ellipsen & -      & > 2    & < 3    & < 3    & < 3    & < 3    & < 3    & < 3    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,4458 & 0,4449 & 0,444  & 0,4432 & 0,4428 & 0,4425 & 0,4423 & 0,4419 \\
        y (Rot)          & 0,4113 & 0,411  & 0,4102 & 0,4096 & 0,4091 & 0,4089 & 0,4086 & 0,4082 \\
        MacAdam Ellipsen & -      & > 1    & > 1    & > 1    & > 1    & 1      & > 2    & > 2    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llll}
        Lux   & Rot   & Grün  & Blau & Weiss\\
        5\%   & 513   & 942   & 199  & 1384 \\
        10\%  & 1384  & 2238  & 498  & 3126 \\
        20\%  & 2811  & 4553  & 928  & 7058 \\
        35\%  & 4879  & 8090  & 1677 & 19883\\
        50\%  & 6910  & 11667 & 2650 & 15640\\
        65\%  & 8927  & 14985 & 3249 & 26787\\
        85\%  & 12662 & 20220 & 3962 & 45830\\
        100\% & 14407 & 22931 & 4383 & 43309\\
    \end{tabular*}
    \caption{Gemessene Luminanz Werte des LEDWash300}
\end{table}
\noindent
\begin{figure}[H]
    \begin{center}
    ...
    \end{center}
    \caption{Darstellung Luminanz der LEDWash Emitter}
\end{figure}
\begin{figure}[H]
    \begin{center}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,6833 & 0,688 & 0,6896  & 0,6899 & 0,6896 & 0,6907 & 0,6912 & 0,6909 \\
        y (Rot)          & 0,3042 & 0,3034 & 0,3028 & 0,3031 & 0,3028 & 0,3023 & 0,3029 & 0,3028 \\
        MacAdam Ellipsen & -      & > 1    & > 1    & > 1    & > 1    & > 1    & > 2    & < 3    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,1803 & 0,1707 & 0,1668 & 0,1675 & 0,1641 & 0,1661 & 0,165 & 0,1658  \\
        y (Rot)          & 0,6916 & 0,6921 & 0,6906 & 0,6905 & 0,6886 & 0,6882 & 0,6885 & 0,6874 \\
        MacAdam Ellipsen & -      & > 1    & > 1    & > 1    & > 1    & > 1    & > 2    & > 5    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,1539 & 0,1539 & 0,1542 & 0,1536 & 0,1538 & 0,1537 & 0,1533 & 0,1528 \\
        y (Rot)          & 0,0264 & 0,0245 & 0,0242 & 0,0251 & 0,0247 & 0,0247 & 0,0262 & 0,027  \\
        MacAdam Ellipsen & -      & > 5    & > 5    & > 5    & > 5    & > 5    & > 5    & > 10   \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,3197 & 0,3177 & 0,3175 & 0,3173 & 0,3163 & 0,3181 & 0,316  & 0,3183 \\
        y (Rot)          & 0,336  & 0,3311 & 0,3321 & 0,3268 & 0,3266 & 0,3337 & 0,3235 & 0,3311 \\
        MacAdam Ellipsen & -      & > 3    & > 2    & > 2    & > 2    & > 2    & > 1    & > 2    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llll}
        ...
        20\%  & 164  & 209   & 69   & 209 \\
        35\%  & 452  & 594   & 174  & 616 \\
        50\%  & 764  & 1196  & 343  & 1227\\
        65\%  & 1467 & 1975  & 551  & 2030\\
        85\%  & 2400 & 3313  & 940  & 3427\\
        100\% & 3112 & 4512  & 1290 & 4695\\
    \end{tabular*}
    \caption{Gemessene Luminanz Werte der LightCan}
\end{table}
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{images/charts/lightCan.png}
    \end{center}
    \caption{Darstellung Luminanz der LightCan Emitter}
\end{figure}
\begin{figure}[H]
    \begin{center}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{.49\textwidth}
        ...
        \caption{Weißer Emitter}
    \end{subfigure}
    \caption{Übersicht der LightCan Emitter xy Koordinaten mit MacAdam Ellipsen}
\end{figure}
\noindent
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,5254 & 0,6009 & 0,6563 & 0,6787 & 0,6787 & 0,6875 & 0,6897 & 0,6908 \\
        y (Rot)          & 0,3216 & 0,3138 & 0,3075 & 0,3049 & 0,3049 & 0,3031 & 0,3022 & 0,3014 \\
        MacAdam Ellipsen & -      & > 1    & > 2    & > 4    & > 6    & < 6    & < 6    & < 6    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,2572 & 0,2038 & 0,1584 & 0,1383 & 0,1331 & 0,1328 & 0,1338 & 0,1364 \\
        y (Rot)          & 0,4691 & 0,5558 & 0,6319 & 0,6661 & 0,6759 & 0,6802 & 0,6823 & 0,6816 \\
        MacAdam Ellipsen & -      & > 1    & > 2    & > 2    & > 3    & 8      & < 8    & < 8    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,1959 & 0,165  & 0,1488 & 0,1433 & 0,1417 & 0,1413 & 0,1406 & 0,1399 \\
        y (Rot)          & 0,1296 & 0,0816 & 0,0563 & 0,0483 & 0,0466 & 0,0456 & 0,0462 & 0,0471 \\
        MacAdam Ellipsen & -      & > 2    & > 4    & > 5    & 9      & < 9    & < 9    & < 9    \\
    \end{tabular*}
...
\begin{table}[H]
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} llllllll}
        Steuerwert [\%]  & 100    & 85     & 65     & 50     & 35     & 20     & 10     & 5      \\
        x (Rot)          & 0,2777 & 0,2852 & 0,2879 & 0,2871 & 0,2869 & 0,286  & 0,2865 & 0,2865 \\
        y (Rot)          & 0,2897 & 0,286  & 0,284  & 0,2821 & 0,2826 & 0,2821 & 0,2812 & 0,2816 \\
        MacAdam Ellipsen & -      & > 1    & > 1    & > 1    & > 1    & > 1    & > 4    & < 4    \\
    \end{tabular*}
    \caption{Farbortverschiebung des weißen LightCan Emitters}
\end{table}
\noindent
\clearpage
