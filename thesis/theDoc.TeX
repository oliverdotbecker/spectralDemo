...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Emitter Übersicht mit Schiebereglern}
\end{figure}
\noindent
...
maximaler asusteuerung eines einzelnen Emitters als auch bei der aussteuerung von mehereren Emittern immer die gleiche Gesamthelligkeit zu
emmitieren.\\
...
\\
Dieser Test zeigt, dass für lineare und annähernd linare Farbmischsysteme eine einzel Emittervermessung ausreichend ist um den möglichen Farbraum
und die Farbmischung vorauszuberechnen. Für nicht linare Farbmischsysteme sind weitere Messungen der tatsächilchen Mischfarben nötig oder der
