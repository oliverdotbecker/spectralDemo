...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.8\textwidth]{images/combined_gamut_with_mix_point_and_math.png}
    \end{center}
...
zu erkennen, dass das kleinere Mixdreieck eine kürzere Gesamtdistanz hat. Somit wird dieses für das weitere Vorgehen genutzt.\\
...
\\
Diese Intensitäten der einzelnen Emitter kann nicht im CIE 1931 Farbraum ermittelt werden.
