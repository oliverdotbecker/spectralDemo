...
Als Referenzmessgerät zu dem vergleichsweisen niedrigpreisigen Sensoren wurde das bei MA Lighting bereits vorhandene Spektralmessgerät
...
Als ein Beispiel kann die Temperatur des Chip in Celsius des \ac{ic}s mit "'ATTEMP"' abgefragt werden.\\
