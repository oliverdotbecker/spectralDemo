...
\\
Dieser Test zeigt, dass für lineare und annähernd lineare Farbmischsysteme eine einzel Emittervermessung ausreichend ist um den Gamut, den möglichen
...
die hier venrwendeten Lichtquellen, bis zu Bewegungssteuerungen mehrerer Achsen, wie des Robe LEDWash 300.\\
...
\subsection{Patch}
Im sogenannten "'Patch"' oder auch "'Adressierung"' legt man fest welche Lampen man steuern möchte. Ein Patch Eintrag besteht aus den Informationen,
des verwendeten Fixturetypen und der DMX Startadresse. Die DMX Startadresse ist die Nummer zwischen 1 und 512, welche man an der Lampe einstellt.
Alle weiteren Steuerkanäle des DMX Modus der Lampe folgen dann auf diese Startadresse. Hier muss bei mehreren Lampen auf einer DMX Linie geachtet
werden, dass keine Lampen sich in ihren Steuerkanälen ungewollt überlappen.\\
...
und Weise wie Emitter und die mehreren angelegten Lampen verwaltet werden umgestellt werden.\\
Die Emitter Sektion wird nun automatisch erzeugt. Anhand der genutzten Fixturetypen wird zusammengetragen welche Art von Emittern benötigt werden.
Für alle verwendeten Emitter wird eine entsprechende Representation mit einem Schieberegler erzeugt. Der "'Add Emitter"' Knopf zum manuellen
...
wird eine inkrementierte Nummer angezeigt, um mehrere Fixtures des gleichen Typs auseinader halten zu können. In der zweiten Spalte wird der Name des
...
ausgegeben werden.\\
Die Spalte "'M"' steht für "'Measure"'. Mit dem anklicken der Zelle wird später automatisierte das Vermessen des Fixtures angestoßen. Mit klicken auf die
...
\cite{artnetPackage}. Zur Art-Net - DMX Umsetzung wurde ein grandMA3 "'xPort Node"' genutzt. Dieser wurde als Protokoll Wandler eingesetzt.\\
%//TODO: Schematischer Aufbau Applikation -> Node (-> WAPP) -> Lampe als Skizze
