...
\end{table}
\noindent
Aus diesen Werten und den mit dem Sensor erfassten Spektralwerten konnten nun die \ac{cie} XYZ Werte errechnet werden. Um nun den graphischen Punkt auf
...
\end{figure}
\noindent
Das Emittermenü bot einige Einstellungsmöglichkeiten wie den Namen und die Farbe zur bessern Zuordnung für den Benutzer, sowie eine Schaltfläche pro zu messende
...
wird eine inkrementierte Nummer angezeigt, um mehrere Fixtures des gleichen Typs auseinaderhalten zu können. In der zweiten Spalte wird der Name des
...
In der Applikation wird mit jeder Einstellung an einem beliebigen Schieberegler das Zusammenstellen neuer DMX Informationen angestoßen.
\clearpage
