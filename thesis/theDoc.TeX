...
\end{figure}
\noindent
Hier wird aus der \ac{uart} (AT) Schnittstelle mit dem Befehl ATCDATA die Sensorwerte der einzelnen Dioden als 32-Bit floating point (Gleitkomma 
Zahlen) ausgegeben. Die weiteren nicht Sensor bezogenen Befehle sind identisch mit dem Befehlssatz des AS7261 Sensors.
\clearpage
