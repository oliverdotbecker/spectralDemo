...
\\
Die hier aufgeführen Gesetze von Graßmann bilden die Grundlage für alle Berechnungen von Koordinaten innerhalb eines Farbraumes. Alle folgenden
Berechnungen dieser Arbeit stützen sich auf diese Gestze. "'Die von Graßmann aufgestellten Gesetze wurden lange Jahre in der wissenschaftlichen
...
\begin{figure}[H]
    \includegraphics[width=.5\textwidth]{images/cie1931.png}
    \caption{CIE 1931 2D Farbraum}
\end{figure}
\noindent
