...
\end{addmargin}
NodeJS ist eine JavaScript Laufzeitumgebung. Laufzeitumgebungen sind zum ausführen eines Programms in einer Sprache zwingend
erforderlich.\\
Appcode hat gegenüber Webcode weitreichendere Befugnisse auf dem Endgerät wie Dateisystemzugriff und externe Schnittstellen, wie
USB oder herkömmliche serielle Schnittstellen (COM).
\clearpage
...
Google.\\
Das Electron Framework bietet eine Betriebssystem übergreifende Applikation als Resultat. Electron Applikationen können unter
...
\subsection{Licht und Licht messen}
...
Licht sowohl in der Ausbreitung wie eine Welle, aber gleichzeitig auch ein Teichenverhalten bei Licht zu beobachten ist nennt sich
Welle-Teilchen-Dualismus. Dieser Begriff wurde durch Albert Einstein und Max Planck begründet. In dieser Theorie wird Licht als Quantenobjekt
...
\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \end{center}
    \vspace{-20pt}
    \caption{Licht im elektromagnetischen Spektrum}
    \vspace{-15pt}
\end{wrapfigure}
\noindent
Licht ist elektromagnetischen Spektrum messbar. Somit ist ein Farbton eine Frequenz und eine Helligkeit eine Amplitude.
...
dem Infraroten Bereich des Spektrums ab 760nm bis in den Ultravioletten Bereich bei 380nm.
\begin{align}
    \lambda = \frac{c}{f}
\end{align}
Die zugehörigen Frequenzen liegen mit (1) bei etwa 394,5 \ac{thz} für Infrarot und circa 789 \ac{thz} für Ultraviolett. Das entspricht einer Bandbreite
von 394,5 \ac{thz} die das menschliche Auge erfassen kann.\\
\\
Dieser Teil des elektromagnetischen Spektrums lässt sich zum Beispiel mit Photodioden messen.\\
\clearpage
...
\begin{thebibliography}{xxxxxxxxxxxxxxxxxxx}
    ...
    \bibitem[Licht Wikipedia, 2019]{wikiLicht}"'Licht - Wikipedia"', https://de.wikipedia.org/wiki/Licht, 11.08.2019
 \end{thebibliography}
 \endgroup
\clearpage
