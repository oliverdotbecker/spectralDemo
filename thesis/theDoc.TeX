...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.9\textwidth]{images/gamut_skypanel.png} %//TODO: Check text to image
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{images/combined_gamut_lightCan_skypanel.png} %//TODO: Check text to image
    \end{center}
