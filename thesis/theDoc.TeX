...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.48\textwidth]{images/MK350N_Basic_Handheld_Spectrometer.png}
    \end{center}
    \caption{UPRtek MK350 LED \cite{uprtek}}
\end{figure}
\noindent
Dieses Messgerät kann Spektraldaten im Bereich von {\color{red} 360} bis {\color{red} 760} nanometern messen. Hier wird ein Messwert pro
einem Nanometer erfasst. Daraus Berechnet das Messgerät weiter \ac{cie} 1931 xy Koordinaten, sowie \ac{cie} 1973 uv Koordinaten.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{images/AS7262_functional_blockdiagram.png}
        \caption{Spektrum MK350}\label{fig:green_spec_MK350} %// TODO Exchange picture
    \end{subfigure}
    \hfill 
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{images/AS7262_spectrum.png}
        \caption{Spektrum AS7262}\label{fig:green_spec_7262} %// TODO Exchange picture
    \end{subfigure}
...
des grünen Emitters bei ca. 480 nanometern. Doch liegen die beiden nächsten Messflanken des AS7262 bei 450 und 500 nanometern (Bild \ref{fig:spec_7262}).
...
\begin{thebibliography}{xxxxxxxxxxxxxxxxxxx}
    ...
    \bibitem[UPRtek Homepage,2019]{uprtek} \url{https://www.uprtek.com/de/product/LED-Test-Measurement-Handspektrometer/MK350N-Basic-Handheld-Spectrometer.html}, 09.09.2019
    \bibitem[Lindbloom Homepage,2019]{lindbloom} \url{http://brucelindbloom.com/index.html}, 09.09.2019
    \bibitem[Wisotop Homepage,2019]{wisotop} \url{https://wisotop.de/Anhang-Tristimulus-Werte.php}, 09.09.2019
 \end{thebibliography}
 \endgroup
\clearpage
