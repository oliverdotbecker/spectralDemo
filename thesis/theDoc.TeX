...
\ac{uart} Schnittstelle zu testen. Dies ist erfogreich gelungen. Es wurden erste spektrale Werte des
Umgebungslichtes empfangen.\\
Anschließend wurde begonnen eine erste NodeJS Applikation zu programmieren, um intervallweise spektrale Daten
von der \ac{uart} Schnittstelle abzufragen und anzuzeigen. So konnten erste Messwerte herhoben werden.
\clearpage
