...
\begin{table}[H]
    ...
    \end{tabular*}
\end{table}
Zunächst wurden \ac{led}s seit ihres bekannt werdens in den frühen 1960er Jahren als Leuchtindikatoren benutzt. Also zum Beispiel auf
...
Es ergaben sich verschiedene Typen von \ac{led}s:\\
 - Niederstrom\\
 - HLED\\
 - COB LED\\
...
\subsection{Menschliches Farbsehen}
