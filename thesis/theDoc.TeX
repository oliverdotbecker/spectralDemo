...
\begin{align}\label{Equ:22}
    ...
    \end{array}\right]
\end{align}
Durch Interpolation zwischen den erfassten Helligkeitsstufen und additiver %//TODO
Farbmischung kann der Farbton einer aktiven Emitterkombination vorausberechnet werden.
\begin{figure}[H]
    \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%% Auswertung %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Auswertung}
Die bisherigen Ausführungen wurden 
