...
weiterem Erhöhen der Temperatur wechselt der Farbton des Metalls über gelb zur sogenannten Weißglut ab rund {\color{red} 1300 Celsius (1573 K)}. %// TODO: This needs to be checked
\begin{figure}[H]
    \begin{center}
...
ein Sinneseindruck einer gelben Farbe. Dies geschieht spektral betrachtet durch eine aufaddierung der Amplituden der einzelnen Welllenlängen.
...
\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \vspace{-15pt}
\end{wrapfigure}
Emittiertes Licht unterligt generell der addidiven Farbmischung. Dieses Prinzip findet beispielsweise Anwendung bei der Farbmischung von \ac{led}s.
...
Reflektiertes Licht unterligt generell der subtraktiven Farbmischung. Nimmt man eine weiße Lichtquelle, enthält diese ein breites Spektrum an Wellenlängen.
...
absorbieren. Absorbiert ein Köper beispielsweise vereinfacht rotes und blaues Licht und wird von einer weißen Lichtquelle angestrahlt reflektiert er grünes
...
"'Die Menge der möglichen Farbemfindungen ist wesentlich kleiner als die der sie erzeugenden spektralen Verteilungen. Oder anders ausgedrückt: eine Farbvalenz
...
\\
Mit diesen Werten wurde begonnen, eine XYZ \ac{cie} Koordinate zu errechnen. Hier wurden die Formeln von Bruce Lindbloom genutzt. Lindbloom's Webauftritt
...
\begin{align}\label{Equ:4}
    ...
    \end{array}\right]
\end{align}
mit sRGB Umrechnungsmatrix mit Weiß-Referenzpunkt D65 %// TODO: D65 irgendwo erklären
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{.49\textwidth}
        ...
        \caption{Errechente Vertices}
    \end{subfigure}
    \caption{Grafische Reperesentation des Sutherland–Hodgman Algorithmus} \label{fig:sutherland_hodgman}
\end{figure}
\noindent
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.7\textwidth]{images/combined_gamut_lightCan_lightStick.png}
    \end{center}
