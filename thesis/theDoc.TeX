...
sowie eine Status-\ac{led} und eine Referenz weißlicht \ac{led} Lichtquelle, zur Beleuchtung von nicht selbst emittierenden
Gegenständen.
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.5\textwidth]{images/AS7262_front.png}
    \end{center}
...
Dies ist ein USB-Seriell-Transceiver. Dieser Chip von der Firma FTDI wandelt \ac{usb} zu RS232 analog Signalen.\\
\\
Die Kommunikation mit dem AMS Sensor funktioniert mit AT-Kommandos. Einer \ac{ascii} basierten Kommando Sprache.
\clearpage
