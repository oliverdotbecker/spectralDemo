...
DMX512-A (ANSI E1.11-2008). DMX basiert elektrisch auf dem seriellen RS-485 (EIA-485)
...
\subsection{Art-Net}
Art-Net ist ein Netzwerkprotokoll zur Verteilung von DMX und RDM Daten. Es ist in OSI Layer 4 auf
UDP aufgebaut. Das Protokoll ist von der Firma Artistic Licence Holdings Ltd. lizenziert.\\
Hier wird Art-Net in der dritten Version verwendet. Diese Version wurde 2011 publiziert.\\
Über das Art-Net 3 Protokoll können bis zu 32.768 DMX Universen verwaltet werden.\\\cite{artnet}
\clearpage
...
\subsection{Github}
Github ist eine webplattform. Dort wurde auch das Git Repository dieses Projektes gehostet.
\clearpage
