...
\begin{wrapfigure}{r}{0.5\textwidth}
    ...
    \caption[Firmensitz Waldbüttelbrunn]{Firmensitz Waldbüttelbrunn \cite{maabout}} %//TODO: Neu oder Text anpassen
    \vspace{-15pt}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \vspace{-25pt}
    \begin{center}
        \includegraphics[width=0.48\textwidth]{images/additive_color_mixing.png} %//TODO: Neu
    \end{center}
    \vspace{-20pt}
...
Der Algorithmus spannt die Gerade zwischen zwei Vertices (P1 und P2) des Gamut A und zwischen zwei Vertices (CP1 und CP2) des Gamut B und prüft, auf
welcher Seite der Geraden des Gamut A sich die Vertices des Gamut B befinden.\\
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.75\textwidth]{images/combined_gamut_with_mix_point_and_math.png} %//TODO: Check text to image
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.8\textwidth]{images/combined_gamut_with_mix_triangles_cyan.png} %//TODO: Check text to image
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{images/app_fixture_sheet_with_reference.png} %//TODO: Check text to image
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.8\textwidth]{images/meassureScenario.png} %//TODO: Legende
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.8\textwidth]{images/meassureScenarioRealistic.png} %//TODO: Legende
    \end{center}
...
\begin{thebibliography}{xxxxxxxxxxxxxxxxxxx}
    ...
    \bibitem[Arri Homepage, 2019]{arriL7} \url{https://www.arri.com/en/lighting/led/l-series/l7-c#F0.0000L7C}. Visited on: 29.10.2019
    ...
    \bibitem[LightCan Manual, 2019]{lightCanDMX} \url{http://download.apelabs.com/manuals/Ape_Labs_-_LightCan_-_Manual_-_web.pdf} Page 33. Visited on: 16.09.2019
    ...
    \bibitem[Optibin, 2019]{macAdamEllipses} "'Optibin - Achieves color consistency with industry-leading LED optimization"'\url{https://www.colorkinetics.com/b-dam/color-kinetics/learn-more/intellihue/PCK-Technology-Overview-Optibin.pdf}. Visited on: 28.10.2019
